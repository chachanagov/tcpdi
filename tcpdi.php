...
class TCPDI extends FPDF_TPL
{
     ...
     * @var object
     */
    public object $current_parser;

    /**
     * object stack
     * @var array
     */
    public array $_obj_stack;

    /**
     * done object stack
     * @var array
     */
    public array $_don_obj_stack;

    /**
     * Current Object Id.
     * @var integer
     */
    public int $_current_obj_id;

    /**
     * The name of the last imported page box
     * @var string
     */
    public string $lastUsedPageBox;

    /**
     * Cache for imported pages/template ids
     * @var array
     */
    public array $_importedPages = [];

    /**
     * Cache for imported page annotations
     * @var array
     */
    public array $_importedAnnots = [];

    /**
     * Number of TOC pages, used for annotation offset
     * @var integer
     */
    public int $_numTOCpages = 0;

    /**
     * First TOC page, used for annotation offset
     * @var integer
     */
    public int $_TOCpagenum = 0;
